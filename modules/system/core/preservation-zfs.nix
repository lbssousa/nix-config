# Módulo de preservação para ZFS: Sistema efêmero com dataset ZFS na raiz
...
# módulo nix-community/preservation.
#
# Diferenças em relação ao perfil Btrfs+tmpfs (preservation.nix):
