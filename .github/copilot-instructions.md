...
- **Build one system target without activating it:** `run0 just system build <host> [gnome|plasma]`
- **Test one system target without making it default:** `run0 just system test <host> [gnome|plasma]`
